...
/**
 *
 *  This solution is taken almost verbatim from the bePrepared website.
 * 
 * See: http://www.skylit.com/beprepared/fr.html
 * 
 * 
 * @author Dr. Baharav
 */
...
public class Phrase
{
  ...
  {
      /* implemntation not shown in the test!!              */
      /* We did this one just so you can run the program    */
    int i = -1;
    while (n > 0)
    {
  ...
  public int findLastOccurrence(String str)
  {
    ...
    return 1;  // Uou need to replace this
  }
  ...
  *
  public int findLastOccurrence(String str)
  {
    ...
    won't get credit because the question specifically asks to use
